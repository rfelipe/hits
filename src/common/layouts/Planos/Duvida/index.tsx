    ...
    return (
        <section className="text-center m-auto mt-20">
            ...
            <div className="mt-20 flex justify-between flex-wrap min-[1230px]:flex-nowrap">
                <div className="flex">
                    <div className="relative z-10 shrink-0 hidden min-[1230px]:block -left-[80px]" >
                        <Image alt="" src={Img1}  />
                    </div>
                    <div className="relative z-10 shrink-0 min-[1230px]:hidden" >
                ...
                <div className="flex ml-auto">
                    ...
                    <div className="min-[1230px]:block hidden absolute -right-[80px]">
                        <Image alt="" src={Img2} className="relative z-0" />
                    </div>
                    <div className="min-[1230px]:hidden">
