        ...
        <section className="text-center m-auto mt-20">
            ...
            <div className="mt-20 flex justify-between flex-wrap xl:flex-nowrap">
                <div className="flex">
                    ...
                    <div className="absolute z-10 left-[99px]     xl:relative flex items-center justify-center xl:bg-white w-[309px] h-[309px] rounded-[100%] ml-[-66px] xl:ml-[-248px] xl:z-0 ">                        
                        <div className="pl-6">
                            <span className="inline-flex justify-center bg-[#C8C3FF]  px-4 py-2 rounded-full w-fit mb-2">Hit #01</span>
                            <p className="text-lg text-center xl:text-left max-w-[150px] mb-2">Quero controlar as despesas do negócio</p>
                            <Button type="red" href="/despesas">Saiba mais</Button>
                        </div>
                    </div>
                </div>
                <div className="flex ml-auto">
                    <div className="absolute z-10   xl:relative flex items-center justify-center xl:bg-white w-[309px] h-[309px] rounded-[100%] mr-[380px] xl:z-0 ">
                        <div className="pr-6">
                            <span className="inline-flex justify-center bg-[#DCF691]  px-4 py-2 rounded-full w-fit mb-2">Hit #01</span>
                            <p className="text-lg text-center  max-w-[150px] mb-2">Quero controlar as despesas com combustível</p>
                            <Button type="red" href="/combustivel">Saiba mais</Button>
                        </div>
                    </div>
                    <div className="xl:block hidden absolute -right-[80px]">
