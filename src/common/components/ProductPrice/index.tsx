                ...
                <div className="container mx-auto">
                    <div className="flex items-center">
                        <svg className="pt-16" width="493" height="634" viewBox="0 0 493 634" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fillRule="evenodd" clipRule="evenodd" d="M91.7536 441.712C133.986 475.64 187.634 495.941 246.023 495.941C304.413 495.941 358.06 475.64 400.293 441.712C358.06 407.784 304.413 387.483 246.023 387.483C187.634 387.483 133.986 407.784 91.7536 441.712Z" fill="#B0EFFF" />
                            <defs>
