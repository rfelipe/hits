    ...
    return (
        <div className='pt-16 md:pt-32'>
            <div className='w-full bg-no-repeat bg-cover bg-center' style={{ 'backgroundImage': `url(${videos.image.src})` }}>
                <div className='lg:max-w-7xl px-6 lg:px-0 lg:ml-auto'>
                    <div className='grid lg:grid-cols-2 h-[560px] place-items-center content-center container grid-cols-none'>
