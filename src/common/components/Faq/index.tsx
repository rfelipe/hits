...
const Faq: React.FC<FaqProps> = ({ faqs }) => {
    ...
    return (
        <div className="pt-32">
            <div className='pb-[100%] md:pb-[50%] lg:pb-[33.33%] '>
                <div className='relative'>
                    <svg className='inset-0 absolute w-screen' width="1440" height="842" viewBox="0 0 1440 842" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M199.422 156.65C257.37 228.751 292.043 320.341 292.043 420.026C292.043 519.711 257.37 611.301 199.422 683.402C141.474 611.301 106.801 519.711 106.801 420.026C106.801 320.341 141.474 228.751 199.422 156.65Z" fill="#B0EFFF" />
                    </svg>
                </div>
