  ...
  const faqs = [
    {
      ...
      items: [
        ...
        },
        {
            ...
            answer: 'O <strong>Controle de Despesas</strong> é o hit ideal para quem quer ter controle de todas as despesas do negócio. Você tem um cartão recarregável com bandeiras Elo e Good Card para usar onde quiser, um aplicativo de carteira virtual para acompanhar e reportar despesas e uma plataforma web para baixar relatórios e ter controle de movimentações.  <br/> <br/> Se sua empresa tem diversas despesas e precisa distinguir os gastos com combustível e mobilidade dos demais custos: é aqui que entra o <strong>Hit Combustível</strong>. Com ele, você consegue separar esses custos de maneira digital, segura e amigável. Imagine simplificar essa tarefa e otimizar a gestão financeira da sua empresa, enquanto contribui para a sustentabilidade. <br/> <br/> Ainda na dúvida? Mande uma mensagem no <a href="" style="text-decoration:underline"><strong>WhatsApp</strong></a> que te ajudamos a escolher o melhor Hit para você!',
        },
        {
            question: 'Como funciona o teste grátis do Hits?',
            answer: 'O teste grátis é a isenção da mensalidade por 60 (sessenta) dias. Para utilizar, basta solicitar seus cartões e começar a usar!',
        },
        {
            question: 'Como usar os meu Hits?',
            answer: 'Com o Hits Controle de Despesas te acompanha no corre do dia a dia, entregando uma solução simples, fácil e prática para usar o cartão onde quiser com uma ampla rede de aceitação nacional e internacional, além de organizar todas as despesas com um aplicativo de carteira digital e controlar todos os relatórios pela plataforma web. <br/><br/> Com o Hits Controle de Combustível, você encontra os melhores preços de combustível na palma da mão, em tempo real. Você pode pagar por serviços essenciais, como táxi, estacionamento, Uber, 99, bicicletas compartilhadas e muito mais, tudo em um único lugar! <br/><br/>Além disso, nosso aplicativo torna tudo mais prático para você organizar suas despesas – desde o IPVA até o seguro e a manutenção do veículo.',
        },
        {
            question: 'Como comprar o meu Hit?',
            answer: 'Depois de escolher o Hit ideal para você, clique nos botões de “Contrate agora” ou nos links a seguir e dê início ao processo de compra, você só precisa inserir seus dados iniciais e solicitar seu cartão :) <br/><br/><a href="" style="text-decoration: underline;">Contratar Controle de Despesas</a><br/><a href="" style="text-decoration: underline;">Contratar Controle de Combustível</a>',
        },
        {
            question: 'Já comprei o meu Hit, e agora?',
            answer: 'Fique de olho em nosso contato por e-mail ou WhatsApp! <br/><br/> Para <strong>Hits Despesas</strong>, finalize pedido na plataforma, próximos passos em nosso contato. <br/><br/>Para <strong>Hits Combustível<strong>, configure e desbloqueie seu cartão na plataforma, use em nossa rede parceira.',
        },
        {
            question: 'Como acessar minha plataforma?',
            answer: 'Acesse pelo computador ou app, como preferir :) <br/><br/> Hits Despesas: <br/><a href="" style="text-decoration: underline;">Portal do Gestor </a><br/><a href="" style="text-decoration: underline;">App do Gestor</a> <br/><br/>Hits Combustível: <br/><a href="" style="text-decoration: underline;">Sou Log + </a><br/><a href="" style="text-decoration: underline;">App do Gestor</a>',
        },
        {
