    ...
    return (
        <MainTemplate>
            ...
            <>
                <div className="pt-14 md:pt-32">
                    ...
                    <div className="flex justify-between flex-wrap md:gap-5">
                        <div className="relative flex items-center w-[704px] h-[500px]">
                            ...
                            <div className="md:pr-6 text-center md:text-left absolute max-md:left-24 max-md:bottom-20 md:right-16">
                        ...
                        <div className="relative flex items-center ml-auto w-[704px] h-[500px]">
                            ...
                            <div className="pr-6 md:text-right text-center max-md:right-16 max-md:bottom-20  absolute md:left-16">
                ...
                <div className="md:pt-32"> {/* DONE MOBILE AND DESK */}
                ...
                <div className="pt-14 md:pt-32"> {/* DONE MOBILE AND DESK */}
